...
select walletID,count(*)as 'count_of_transactions' from Cashback
group by walletID
...
AS
select count(p.paymentID) as no_Transact, sum(pb.pointsAmount) as sun_Points from Payment P
...
go
--drop proc [Account_Payment_Points]
go
--//////////////////////////////////////////////////////////////////////////////////////////////////////
------------------------------------------------------------------------------------------------------------
...
AS
select count(t.ticketID) as count_Ticket from Technical_support_ticket t
inner join customer_account a 
on t.mobileNo = a.mobileNo
where t.status <> 'resolved' and a.nationalID = @NID
go
drop proc [Ticket_Account_Customer]--updated for ease of use
go
...
declare @result int
set @result = dbo.Wallet_Transfer_Amount(1,'2005-01-01','2025-01-01')
print @result
...
SELECT * FROM customer_account WHERE MobileNo = '01000000001' AND pass = 'password1';
DROP TABLE __EFMigrationsHistory;

INSERT INTO customer_profile
VALUES
(1, 'John', 'Doe', 'john.doe@example.com', '123 Elm Street, Springfield', '1985-06-15'),
(2, 'Jane', 'Smith', 'jane.smith@example.com', '456 Oak Avenue, Springfield', '1990-09-10'),
(3, 'Mike', 'Johnson', 'mike.johnson@example.com', '789 Pine Road, Springfield', '1988-12-05'),
(4, 'Emily', 'Davis', 'emily.davis@example.com', '101 Maple Blvd, Springfield', '1992-02-22'),
(5, 'David', 'Miller', 'david.miller@example.com', '202 Birch Drive, Springfield', '1983-04-11');

INSERT INTO customer_account (mobileNo, pass, balance, account_type, start_date, status, points, nationalID)
VALUES
('12345678901', 'password1', 100.5, 'postpaid', '2020-01-01', 'active', 10, 1),
('23456789012', 'password2', 50.75, 'prepaid', '2021-03-15', 'active', 20, 2),
('34567890123', 'password3', 200.0, 'pay-as-you-go', '2022-07-30', 'onhold', 15, 3),
('45678901234', 'password4', 150.25, 'postpaid', '2020-10-25', 'active', 5, 4),
('56789012345', 'password5', 300.0, 'prepaid', '2023-06-12', 'active', 25, 5);
...
VALUES 
(1, '123 Tech Street, Downtown', '9 AM - 9 PM'),
(2, '456 Home Avenue, Midtown', '10 AM - 8 PM'),
(3, '789 Book Lane, Uptown', '11 AM - 7 PM');

INSERT INTO E_shop (shopID, URL, rating)
VALUES 
(4, 'https://www.gadgethub.com', 4),
(5, 'https://www.fashionfiesta.com', 5);

INSERT INTO Voucher (value, expiry_date, points, mobileNo, redeem_date, shopid)
VALUES 
(100, '2024-12-31', 50, '23456789012', '2024-12-01', 1), -- Example voucher for Shop 1
(200, '2025-01-31', 100, '23456789012', '2024-11-15', 2), -- Example voucher for Shop 2
(150, '2024-12-15', 75, '45678901234', '2024-11-20', 2), -- Example voucher for Shop 3
(50, '2024-12-20', 25, '23456789012', '2024-11-25', 1), -- Another voucher for Shop 1
(300, '2025-03-31', 150, '23456789012', '2024-11-30', 2), -- Example voucher for Shop 4
(120, '2024-12-31', 60, '23456789012', '2024-11-10', 2), -- Example voucher for Shop 5
(80, '2024-12-10', 40, '23456789012', '2024-11-22', 1); -- Another voucher for Shop 3

INSERT INTO Technical_support_ticket (mobileNo, issue_description, priority_level, status)
VALUES
('12345678901', 'Internet not working', 1, 'Resolved'),
('12345678901', 'Router overheating', 2, 'Open'),
('12345678901', 'Slow internet', 3, 'Resolved'),
('12345678901', 'No connectivity', 1, 'In progress');

INSERT INTO Service_plan (name, price, SMS_offered, minutes_offered, data_offered, description)
VALUES
('Basic Plan', 50, 100, 200, 500, 'A basic plan for casual users'),
('Standard Plan', 100, 500, 1000, 2000, 'A standard plan for moderate users'),
('Premium Plan', 200, 1000, 2000, 5000, 'A premium plan for heavy users'),
('Family Plan', 300, 2000, 4000, 10000, 'A plan for families'),
('Student Plan', 75, 300, 600, 1000, 'A plan designed for students');

INSERT INTO Subscription (mobileNo, planID, subscription_date, status)
VALUES
('12345678901', 1, '2023-01-01', 'active'),
('23456789012', 2, '2023-02-15', 'active'),
('34567890123', 3, '2023-03-10', 'onhold'),
('45678901234', 4, '2023-04-05', 'active'),
('56789012345', 5, '2023-05-20', 'active');

INSERT INTO Plan_Usage (start_date, end_date, data_consumption, minutes_used, SMS_sent, mobileNo, planID)
VALUES
('2023-06-01', '2023-06-30', 200, 300, 50, '12345678901', 1),
('2023-06-01', '2023-06-30', 1500, 800, 300, '23456789012', 2),
('2023-06-01', '2023-06-30', 4000, 1800, 600, '34567890123', 3),
('2023-06-01', '2023-06-30', 8000, 3500, 1200, '45678901234', 4),
('2023-06-01', '2023-06-30', 1000, 600, 100, '56789012345', 5),

('2023-07-01', '2023-07-31', 250, 400, 75, '12345678901', 1),
('2023-07-01', '2023-07-31', 1600, 900, 350, '23456789012', 2),
('2023-07-01', '2023-07-31', 4500, 1900, 700, '34567890123', 3),
('2023-07-01', '2023-07-31', 8500, 3700, 1300, '45678901234', 4),
('2023-07-01', '2023-07-31', 1100, 650, 125, '56789012345', 5);

INSERT INTO Payment (amount, date_of_payment, payment_method, status, mobileNo)
VALUES
(50.0, '2024-11-01', 'credit', 'successful', '12345678901'),
(100.0, '2024-11-02', 'cash', 'successful', '23456789012'),
(75.0, '2024-11-03', 'credit', 'rejected', '34567890123'),
(200.0, '2024-11-04', 'cash', 'pending', '45678901234'),
(300.0, '2024-11-05', 'credit', 'successful', '56789012345');
...
VALUES
(500.00, 'EGP', '2024-12-01', 1, '12345678901'),
(1000.50, 'EGP', '2024-12-01', 2, '23456789012'),
(750.25, 'EGP', '2024-12-01', 3, '34567890123'),
(250.75, 'EGP', '2024-12-01', 4, '45678901234'),
(1250.00, 'EGP', '2024-12-01', 5, '56789012345');

INSERT INTO transfer_money (walletID1, walletID2, amount, transfer_date)
VALUES
(1, 2, 100.00, '2024-12-02'),
(2, 3, 200.00, '2024-12-03'),
(3, 4, 50.00, '2024-12-04'),
(4, 5, 300.00, '2024-12-05'),
(5, 1, 150.00, '2024-12-06');

INSERT INTO Benefits (description, validity_date, status, mobileNo)
VALUES
('5% Cashback on purchases', '2025-01-01', 'active', '12345678901'),
('Free 2GB data', '2024-12-31', 'active', '23456789012'),
('Double points on purchases', '2024-12-15', 'expired', '34567890123'),
('Free calls for a day', '2024-12-25', 'active', '45678901234'),
('Extra 100 SMS', '2024-12-20', 'expired', '56789012345');
...
exec dropAll
go
SELECT * FROM dbo.Account_Usage_Plan('12345678901', '2024-01-01');

select * from Benefits;
select * from plan_provides_benefits;
select * from wallet;
select * from Service_plan
SELECT [dbo].[Wallet_Cashback_Amount](3, 3);

Select sum(c.amount) from Cashback c inner join plan_provides_benefits pb on c.benefitID = pb.benefitid where c.walletID = 3 and pb.planID = 3
SELECT CAST([dbo].[Wallet_MobileNo](12345678901) as INT) as Value
SELECT [dbo].[Wallet_MobileNo]('12345678901');
